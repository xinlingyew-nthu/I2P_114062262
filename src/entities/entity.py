...
class Entity:
    ...
    def __init__(self, x: float, y: float, game_manager: GameManager) -> None:
        ...
        self.animation4 = Animation(
            "character/ow4.png", ["down", "left", "right", "up"], 4,
            (GameSettings.TILE_SIZE, GameSettings.TILE_SIZE)
        )
        self.animation5 = Animation(
    ...
    def camera(self) -> PositionCamera:
        ...
        '''
        return PositionCamera(int(self.position.x-GameSettings.SCREEN_WIDTH//2), int(self.position.x-GameSettings.SCREEN_HEIGHT//2))
