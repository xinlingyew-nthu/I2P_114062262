...
class GameManager:
    ...
    def to_dict(self) -> dict[str, object]:
        ...
        return {
            ...
            "settings" :{
                ...
                "mute_bgm" :GameSettings.MUTE_BGM,
            }
        }
    ...
    def from_dict(cls, data: dict[str, object]) -> "GameManager":
        ...
        if settings_data is not None:
            GameSettings.AUDIO_VOLUME = settings_data.get("volume", GameSettings.AUDIO_VOLUME)
            GameSettings.MUTE_BGM     = settings_data.get("mute_bgm",     GameSettings.MUTE_BGM)
